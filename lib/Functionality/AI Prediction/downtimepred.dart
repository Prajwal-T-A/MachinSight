...
class Downtimepred extends StatelessWidget {
  const Downtimepred({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("AI Based Downtime Prediction"),
          ...
          GestureDetector(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color.fromARGB(255, 16, 135, 111),
                    //curve the corners
