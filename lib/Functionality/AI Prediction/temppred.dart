...
class TempPrediction extends StatefulWidget {
  const TempPrediction({super.key});

  @override
  _TempPredictionState createState() => _TempPredictionState();
}

class _TempPredictionState extends State<TempPrediction> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Prediction based on Temperature"),
