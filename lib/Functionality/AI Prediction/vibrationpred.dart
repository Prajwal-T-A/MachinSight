...
class Vibrationpred extends StatefulWidget {
  const Vibrationpred({super.key});

  @override
  _VibPredictionState createState() => _VibPredictionState();
}

class _VibPredictionState extends State<Vibrationpred> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Prediction based on Vibration Levels"),
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: 'Enter Vibration Level (mm/s)',
                labelStyle: TextStyle(color: Colors.white),
                border: OutlineInputBorder(),
              ),
              style: TextStyle(color: Colors.white),
